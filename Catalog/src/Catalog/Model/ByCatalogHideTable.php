...
class ByCatalogHideTable extends SampleTable
{
    protected $table = 'by_catalog_hide';

    public function __construct(Adapter $adapter)
    {
        $this->adapter = $adapter;
        $this->resultSetPrototype = new ResultSet();
        $this->resultSetPrototype->setArrayObjectPrototype(new ByCatalogHide());
        $this->initialize();
    }
    ...
    public function save(ByCatalogHide $entity)
    {
        $data = $entity->toArray();
